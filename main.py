...
class MyGame(arcade.Window):
	...
	def setup(self):
		...
		self.player_sprite = Player("images/Hit.png", SPRITE_SCALING)
		...
		for i in range(SPRITE_SIZE, SCREEN_HEIGHT, 50):
			for j in range(SPRITE_SIZE, SCREEN_WIDTH, 50):
				terrain_sprite = arcade.Sprite("images/terrain.jpg", SPRITE_SCALING)
		...
		for i in range(SPRITE_SIZE, SCREEN_WIDTH, 50):
			terrain_sprite = arcade.Sprite("images/wall.jpg", SPRITE_SCALING)
